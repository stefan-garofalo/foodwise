...
const sheetVariants = cva(
	'fixed z-50 gap-4 bg-background p-6 border-sheet-border shadow-lg transition ease-in-out data-[state=closed]:duration-300 data-[state=open]:duration-500 data-[state=open]:animate-in data-[state=closed]:animate-out',
	{
		variants: {
			side: {
...
const SheetHeader = ({
	...
	<div
		className={merge('flex flex-col space-y-2 text-center sm:text-left', className)}
		{...props}
	/>
)
...
const SheetTitle = ({
	...
	<SheetPrimitive.Title
		ref={ref}
		className={merge('text-foreground text-lg font-semibold', className)}
		{...props}
	/>
)
